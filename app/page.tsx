...
export default function SuenosFelicesLanding() {
  ...
  const serviceImages = [
    ...
    "/images/jardin-encantado.jpg",
    "/images/bosque-nordico.jpg",
    "/images/llamitas-nortenas.jpg",
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3 group">
            <div className="transition-transform duration-300 group-hover:scale-110">
              <img src="/images/logo.jpg" alt="Sueños Felices Pijamadas" className="w-12 h-12 object-contain" />
            </div>
            <div>
              <h1 className="text-xl font-bold text-[#DC8C47] transition-colors duration-300 group-hover:text-[#DC9171]">
                Sueños Felices
              </h1>
      ...
      <section className="py-12 md:py-20 px-4 relative">
        <div className="container mx-auto text-center relative z-10">
          ...
          <div className="relative">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-[#DC8C47] mb-4 md:mb-6 leading-tight animate-fade-in">
              Sueños Felices
              <span className="block text-[#DC9171]">Pijamadas</span>
            </h1>
          </div>
      ...
      <section id="galeria" className="py-20 px-4 bg-white/50 relative">
        <div className="container mx-auto">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="relative overflow-hidden rounded-2xl shadow-2xl group">
              <img
                src={serviceImages[currentImageIndex] || "/placeholder.svg"}
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent transition-opacity duration-300 group-hover:from-black/30"></div>
            </div>
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white border-[#DC8C47] text-[#DC8C47] transition-all duration-300 hover:scale-110 hover:shadow-lg"
              onClick={prevImage}
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white border-[#DC8C47] text-[#DC8C47] transition-all duration-300 hover:scale-110 hover:shadow-lg"
              onClick={nextImage}
            >
              ...
              {serviceImages.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 hover:scale-125 ${
                    index === currentImageIndex ? "bg-[#DC8C47] scale-125" : "bg-[#DC8C47]/30 hover:bg-[#DC8C47]/60"
                  }`}
